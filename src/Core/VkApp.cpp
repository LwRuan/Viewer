...
void VkApp::createUniformBuffers(){//no staging buffer because matrix change every frame
...
void VkApp::createImage(uint32_t width, uint32_t height, VkFormat format, 
...
VkFormat VkApp::findSupportedFormat(const std::vector<VkFormat>& candidates, 
